...
*/
(function(c){"function"===typeof define&&define.amd?define(["jquery","datatables.net"],function(a){return c(a,window,document)}):"object"===typeof exports?module.exports=function(a,d){a||(a=window);if(!d||!d.fn.dataTable)d=require("datatables.net")(a,d).$;return c(d,a,a.document)}:c(jQuery,window,document)})(function(c,a,d){var g=c.fn.dataTable;c.extend(!0,g.defaults,{dom:"<'row-fluid dt-search'<'col-xs-5'l><'col-xs-7'f>><'row-fluid dt-table'<'col-xs-12 p-0 m-t-5 m-b-5'tr>><'row-fluid dt-page'<'col-xs-5'i><'col-xs-7'p>>",
...
o.page(a.data.action).draw("page")};m=0;for(h=g.length;m<h;m++)if(b=g[m],c.isArray(b))q(d,b);else{f="";j=!1;switch(b){case "ellipsis":f="&#x2026;";e="disabled";break;case "first":f=l.sFirst;e=b+(0<i?"":" disabled");break;case "previous":f="<i class='mdi mdi-keyboard_arrow_left'></i>";e=b+(0<i?"":" disabled");break;case "next":f="<i class='mdi mdi-keyboard_arrow_right'></i>";e=b+(i<n-1?"":" disabled");break;case "last":f=l.sLast;e=b+(i<n-1?"":" disabled");break;default:f=b+1,e="",j=i===b}j&&(e+=" mdl-button--raised mdl-button--colored");f&&(j=c("<button>",{"class":"mdl-button mdl-button--icon"+
